...
* Emphasize important words using <b>blockings</b> and <b>normalizers</b>
* Strip strings down to the essentials with <b>normalizers</b>
...
Adding a normalizer like <tt>/(boeing).*(7\d\d)/i</tt> will cause "BOEING COMPANY 747" and "boeing747" to be scored as if they were "BOEING 747" and "boeing 747", respectively. See also "Case sensitivity" below.
